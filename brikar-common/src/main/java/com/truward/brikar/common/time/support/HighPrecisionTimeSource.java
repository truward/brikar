package com.truward.brikar.common.time.support;
...
/**
 * Implementation of {@link com.truward.brikar.common.time.TimeSource} that uses {@link System#nanoTime()} in order
