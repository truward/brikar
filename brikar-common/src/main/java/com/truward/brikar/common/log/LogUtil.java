...
import com.truward.brikar.common.log.regula.Regula;
...
public final class LogUtil {
  ...
  public static final String REGULA_ENTRY = "@regula";
  ...
  public static void writeRegula(Logger log, Regula regula) {
    if (!log.isInfoEnabled()) {
      return;
    }

    log.info(regula.isFailed() ? SHORT_FAILED_REGULA_FORMAT : SHORT_REGULA_FORMAT,
        regula.getPlace(), regula.getStartTimeMillis(), regula.getTimeDeltaMillis());
  }
  ...
  private static final String REGULA_HEADING = REGULA_ENTRY + "={" + PLACE + "={}, " + START_TIME + "={}, " +
      TIME_DELTA + "={}";
